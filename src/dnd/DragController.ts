...
export class DragController {
  ...
  private orderControls = new Map<NodeId, ChildOrderCommit>();
   ...
   *
   * Kept in its own registry rather than on `registerDropTarget`, whose later
   * registration silently replaces an earlier one for the same id.
   */
