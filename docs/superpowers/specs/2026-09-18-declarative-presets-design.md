...
**Status, 2026-09-18: designed; phase 1 in progress on branch `exotic-layout-fixtures`. Phase 2
is built except grid `sticky`; of phases 3–4, `iconFrom`, `wrap`, `hints.aspect` and `justified`
